                    ...
                    do {
                        ...
                        switch (sceltaMenu1) {
                            case 1: {
                                ...
                                if (ListaMaghi.addMago(new Mago(nome, 35, 30, codaTurni, duelloInCorso, -1, livello))) {
                        ...
                        switch (sceltaMenu2) {
                            case 1: {
                                ...
                                for (int i = 0; i < x; i++) {
                                    ...
                                    Mago nuovoMago = new Mago(nomeMago, 35, 30, codaTurni, duelloInCorso, -1, livello);
...
//                                    DEBUGGINO
//                                    System.out.println("Numero maghi rimasti: " + ListaMaghi.getLength());
//                                    System.out.println("Numero squadre rimaste: " + SquadMaghi.vettoreDiVettori.size());
